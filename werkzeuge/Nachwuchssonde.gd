...
func _ready() -> void:
	...
	_log("")
	_log("%-8s %9s %9s %8s %8s %9s %10s" % ["Saison", "Kader Ø", "Streuung",
		"u23 Ø", "Alter Ø", "Talente", "Kadergröße"])
	_bericht(0, d, lid)
