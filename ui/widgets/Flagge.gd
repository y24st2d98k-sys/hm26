...
const FLAGGEN := {
	...
	# Weitere Nationen echter Spieler (Datensatz 2026/27), bewusst schlicht.
	"ru": {"art": Art.WAAGERECHT, "farben": [W, B, R]},
	"ar": {"art": Art.WAAGERECHT, "farben": [HB, W, HB]},
	"ge": {"art": Art.KREUZ, "farben": [W, R]},
	"xk": {"art": Art.EINFARBIG, "farben": [B, G]},
	"ir": {"art": Art.WAAGERECHT, "farben": [GR, W, R]},
	"ma": {"art": Art.EINFARBIG, "farben": [R, GR]},
	"ng": {"art": Art.SENKRECHT, "farben": [GR, W, GR]},
	"co": {"art": Art.WAAGERECHT, "farben": [G, G, B, R]},
	"md": {"art": Art.SENKRECHT, "farben": [B, G, R]},
	"cl": {"art": Art.WAAGERECHT, "farben": [W, R]},
	"us": {"art": Art.WAAGERECHT, "farben": [R, W, R, W, B]},
	"ee": {"art": Art.WAAGERECHT, "farben": [HB, S, W]},
	"cv": {"art": Art.WAAGERECHT, "farben": [B, W, R, W, B]},
	"ao": {"art": Art.WAAGERECHT, "farben": [R, S]},
	"sn": {"art": Art.SENKRECHT, "farben": [GR, G, R]},
	"kz": {"art": Art.EINFARBIG, "farben": [HB, G]},
	"bh": {"art": Art.SENKRECHT, "farben": [W, R, R]},
	"lu": {"art": Art.WAAGERECHT, "farben": [R, W, HB]},
	"bg": {"art": Art.WAAGERECHT, "farben": [W, GR, R]},
	"uy": {"art": Art.WAAGERECHT, "farben": [W, HB, W, HB, W]},
	"ve": {"art": Art.WAAGERECHT, "farben": [G, B, R]},
	"cm": {"art": Art.SENKRECHT, "farben": [GR, R, G]},
	"ci": {"art": Art.SENKRECHT, "farben": [OR, W, GR]},
	"gn": {"art": Art.SENKRECHT, "farben": [R, G, GR]},
	"cd": {"art": Art.EINFARBIG, "farben": [HB, R]},
	"cg": {"art": Art.SENKRECHT, "farben": [GR, G, R]},
	"sa": {"art": Art.EINFARBIG, "farben": [GR, W]},
	"kw": {"art": Art.WAAGERECHT, "farben": [GR, W, R]},
	"al": {"art": Art.EINFARBIG, "farben": [R, S]},
	"am": {"art": Art.WAAGERECHT, "farben": [R, B, OR]},
	"az": {"art": Art.WAAGERECHT, "farben": [HB, R, GR]},
	"cy": {"art": Art.EINFARBIG, "farben": [W, OR]},
	"mx": {"art": Art.SENKRECHT, "farben": [GR, W, R]},
	"ca": {"art": Art.SENKRECHT, "farben": [R, W, R]},
	"au": {"art": Art.EINFARBIG, "farben": [B, W]},
	"gb": {"art": Art.KREUZ, "farben": [B, R]},
}
